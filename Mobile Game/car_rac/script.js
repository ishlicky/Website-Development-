        ...
        function sayHello() {
  const msg = new SpeechSynthesisUtterance('first ofall that game developed by ishimwe jean claude and ishime kevin  INSTRUCTIONS:Use Arrow keys to move the car If you hit any car then game will end, guide for that game are:first,to start play yuo click on start to play.second to go on next step you click on the link');
